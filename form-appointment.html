        ...
        <div class="col-md-12">
          ...
          <form id="appointment_form_popup" name="appointment_form" class="appointment-form" method="post" >
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="mb-3 mb-30">
                  <input placeholder="Mobile" type="text" name="phone" class="form-control required">
                </div>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-sm-12">
                <div class="mb-3 mb-0 mt-0">
                  ...
                  <input type="submit" class="btn btn-theme-colored1 btn-round" data-loading-text="Please wait..." value="Send">
                </div>
              </div>
            </div>
          </form>
